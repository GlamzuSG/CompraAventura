...
## Instrucciones para agregar los enlaces

Luego de compartir cada chat de Clarita Review, copia la URL aquí.
Ejemplo de formato:

```
| US-01 | https://clarita.ejemplo.cl/chat/abc123 |
```
...
> **Nota:** Completar las URLs de los chats antes de la entrega del 2 de junio a las 10:00 AM.
> Ver sección 9 del documento de evaluación: se debe compartir el chat, copiar la URL
> e incluirla en este archivo.
